...
## User Story
As a user, I want all dates in the application to be displayed in the European format (DD.MM.YYYY), so that the information matches my local conventions and is easier to read.
